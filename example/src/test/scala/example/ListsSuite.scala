...
*/
  ...
  test("max of negative list") {
    assert(max(List(-1,-2,-3,-4)) === -1)
  }

  test("sum of negative list") {
    assert(sum(List(-1,-2,-3,-4)) === -10)
  }

  test("max of repeating list") {
    assert(max(List(5,5,5,5)) === 5)
  }

  test("sum of repeating list") {
    assert(sum(List(5,5,5,5)) === 20)
  }
